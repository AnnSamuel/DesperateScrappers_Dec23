...
public class Hypothyroidism extends BaseClass {
	...
	public void thyroidScrape() {
		...
		scrapeAcrossPages("/recipes-for-hypothyroidism-veg-diet-indian-recipes-849","Hypothyroidism Elimination", "HypothyroidismSheet");
...
//			hasNextPage = document.select("id=)
		...
		List<RecipePojo> filteredList = CommonUtils.getFilteredList(recipeList, CommonUtils.getEliminationAddList(
				"C:\\Users\\Spandu\\git\\DesperateScrappers_Dec23\\resources\\excelReader\\Elimination&AddList.xlsx", eliminationSheetName, 0));

		ExcelWriter.writeDataToExcel(filteredList, "C:\\Users\\Spandu\\git\\DesperateScrappers_Dec23\\target\\recipies.xlsx", createSheetName);	//target/recipies.xlsx
	}
...
//			System.out.println(recipeName);
				...
				recipe.setMorbidConditions("Hypothyroidism");
